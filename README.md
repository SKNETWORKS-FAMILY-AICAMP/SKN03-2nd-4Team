...
##  11. 한줄 회고 
이번 프로젝트는 다양한 데이터 소스를 통합하고 이를 웹서비스로 배포하는 과정에 초점을 맞추었습니다. 특히 AWS를 활용한 서버 및 데이터베이스 구축, 프론트엔드와 백엔드의 통합, 데이터 시각화 등 여러 기술적 도전을 해결하며, 안정적이고 효율적인 웹서비스를 구현하는 데 큰 성과를 거둘 수 있었습니다. 이 경험을 통해 실질적인 배포 과정의 복잡성을 이해하고, 문제 해결 능력을 더욱 강화할 수 있었습니다.